...
function list(container) {
  return R.filter(isPiece, dom.siblings(container));
}
...
// ---------------
/**
 * Checks if element is a piece.
 * @param  {HTMLElement}  element - Html element
 * @return {boolean} True if element has piece class
 */
function isPiece(element) {
  return dom.hasClass(element, CSS_CLASS);
}
