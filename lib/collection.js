...
// ------------------
/**
 * @property (function) remapAsItem - Remaps collection elements as item - #curried.
 * @private
 */
let remapAsItem = mapWithIndex(asItem);
/**
 * @property (function) sortedOrRandom - Uses remapAsItem or remapAsItemAndShuffle based on predicate - #curried.
 * @private
 */
...
/**
 * @property (function) bgXFrom - Gets "x" property and negates it  #curried.
 * @private
 */
let bgXFrom = R.compose(R.negate, R.prop('x'));
/**
 * @property (function) bgYFrom - Gets "y" property and negates it  #curried.
 * @private
 */
let bgYFrom = R.compose(R.negate, R.prop('y'));
