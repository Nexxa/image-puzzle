...
/**
 * Remaps item as an object with index.
 * @param  {number} item - The item as numbered index
 * @return {object} The item as object with index
 */
function withIndex(item) {
  return _.set({}, 'index', item);
}
...
/**
 * Adds randomIndex to piece.
 * @private
 * @param  {object} piece       - Piece object
 * @param  {number} randomIndex - Random index
 * @return {object} Piece object
 */
function withRandomIndex(piece, randomIndex) {
  return _.set(piece, 'randomIndex', randomIndex + 1);
}
