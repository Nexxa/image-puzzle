 ...
 * @return {function}
 */
let renderWithPairsOrRandom = R.pipe(withPairsOrRandom, R.tap(vdom.render));
/**
 * #curried - Updates vdom with random pairs.
 * @private
 * @return {function}
 */
let updateWithRandom = R.pipe(randomPairs, R.tap(vdom.update));
/**
 * #curried - Updates vdom with flipped pairs.
 * @private
 * @return {function}
 */
let updateWithFlipped = R.pipe(flippedPairs, R.tap(vdom.update));
